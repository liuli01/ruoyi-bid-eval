...
class ReviewSettings:
    """
    评审配置（os-bid-eval-web 迁移）
    """

    EVAL_PROJECTS_PATH = 'vf_admin/eval_projects'
    ...
    def __init__(self) -> None:
        if not os.path.exists(self.EVAL_PROJECTS_PATH):
            os.makedirs(self.EVAL_PROJECTS_PATH)
...
class GetConfig:
    ...
    def get_review_config(self) -> ReviewSettings:
        """
        获取评审配置
        """
...
# 评审配置
ReviewConfig = get_config.get_review_config()
